...
if __name__ == "__main__":
	...
	path_in = 			root_path / args["input_dir"]
	path_out = 			root_path / args["output_dir"]
	...
	for processed_count, curr_path_in in enumerate(paths_imgs):
		...
		print("Processing image", processed_count, "of", len(paths_imgs), "| Variations:", len(position_list), "| Invalid:", invalid_count, end="\r")
